        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="card p-6 sticky top-24">
              <h2 className="text-base font-semibold text-primary mb-5">{t('car_detail.rental_form_title')}</h2>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      ...
                      <input required type="date" className="input-field" value={form.pickup_date} onChange={(e) => setField('pickup_date', e.target.value)} />
                    </div>
                    <div>
                      <label className="label">{t('car_detail.return_date')} *</label>
                      <input required type="date" className="input-field" value={form.return_date} onChange={(e) => setField('return_date', e.target.value)} />
                    </div>
                  </div>
                  <div>
                  ...
                  {formError && (
                    <p className="text-danger text-xs">{t('car_detail.error_msg')}</p>
                  )}
                  <button type="submit" disabled={submitting} className="btn-gold w-full text-sm py-3.5 disabled:opacity-60 disabled:cursor-not-allowed">
