    ...
    <footer className="bg-card border-t border-border mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          {/* Links */}
          <div>
            <h4 className="text-xs font-semibold uppercase tracking-widest text-secondary mb-4">Navigation</h4>
            <ul className="space-y-2">
              {[
                ...
                <li key={to}>
                  <Link to={to} className="text-sm text-secondary hover:text-gold transition-colors">
                    {label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <div className="flex space-x-4 mt-4">
              <a href="#" aria-label="Instagram" className="text-secondary hover:text-gold transition-colors">
              ...
              <a href="#" aria-label="Facebook" className="text-secondary hover:text-gold transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-border mt-8 pt-6 flex flex-col sm:flex-row justify-between items-center text-xs text-secondary">
